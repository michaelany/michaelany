...
const RU = {
  ...
  stopWar: {
    text: 'Я русский, а также украинец, моя семья живет и в Украине, и в России. Моя родина под руководством военных преступников напала на родину. Это безумие! Нужно остановить это! <0>НЕТ ВОЙНЕ!</0>',
    firstHelp: 'Как вы можете помочь',
