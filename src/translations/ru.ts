...
const RU = {
  ...
  skills: {
    text: 'Разрабатываю <0>приложения</0>, <1>админки</1>, <2>лендинги</2> и <3>многостраничные сайты</3>. Любимый стек - <4>{{0}}</4> + <4>{{1}}</4> + <4>{{2}}</4> + <4>{{3}}</4> + <4>{{4}}</4>. Делаю <5>{{5}}-ролики</5> в {{6}}',
    feature: {
      interface: {
