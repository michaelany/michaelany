  ...
  skills: {
    ...
    feature: {
      ...
      ai: {
        ...
        text: 'Пользуюсь {{0}}-агентами для разработки, ревью и анализа. Нравится {{1}} и {{2}}. Занимаюсь промпт-инжинирингом, валидирую {{0}} output, работаю с {{3}}. Понимаю возможности и ограничения генеративного {{0}}',
      },
      integrations: {
