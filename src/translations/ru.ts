...
const RU = {
  ...
  about: {
    text: 'Я инженер-программист, занимаюсь <0>фронтенд разработкой</0>. Создаю проекты любой сложности с нуля, воплощая в жизнь {{0}} идеи. Веду собственный <0>канал на {{1}}</0>. Живу в Новой Зеландии',
    feature: {
      projects: {
      ...
      education: {
        ...
        text: 'Окончил "Московский технологический университет" и "Всероссийский государственный институт кинематографии". Учеба в последнем хорошо прокачала мои гибкие навыки',
      },
      actor: {
        label: 'Бывший профессиональный актер',
        text: 'Когда-то я снимался в кино, сериалах и рекламе, проводил мероприятия ведущим, подрабатывал аниматором и играл в учебном театре. Но потом опомнился и ушел в программирование',
      },
      sport: {
  ...
  skills: {
    text: 'Разрабатываю <0>приложения</0>, <0>админки</0>, <0>лендинги</0> и <0>многостраничные сайты</0>. Основной стек - {{0}} + {{1}} + {{2}}. Делаю <0>{{3}}-ролики</0> в {{4}}',
    feature: {
      interface: {
      ...
      vlog: {
        ...
        text: 'Пишу и редактирую сценарий, планирую съемку, снимаю, монтирую, делаю цветокоррекцию, обрабатываю аудио, создаю обложки и публикую видео',
      },
    },
    subtitle: 'Технологии',
    technologyGroup: {
