  ...
  skills: {
    ...
    feature: {
      interface: {
        ...
        text: 'Разрабатываю аккуратные интерфейсы с понятным взаимодействием и продуманной бизнес-логикой. Понимаю, когда стоит использовать конкретный элемент, компонент или виджет. Забочусь о безопасности и обрабатываю ошибки',
      },
      performance: {
      ...
      integrations: {
        ...
        text: 'Подключаю платежные системы, headless CMS, аналитику и внешние платформы. Есть опыт интеграции SDK и API Stripe, Airwallex, Strapi, Firebase, Amplitude и других сервисов. Адаптирую интеграции под требования проекта',
      },
      cicd: {
