...
const RU = {
  ...
  experience: {
    ...
    stepper: {
      step1:
        'Работал <0>инженером технической поддержки</0> в компании "{{0}}"',
  ...
  portfolio: {
    ...
    project: {
      ...
      services: {
        text:
          'Лендинг описания услуг новозеландского диджитал-агентства "{{0}}"',
      },
      fcdc: {
  ...
  contact: {
    text: {
      ...
      part3:
        'Отправьте мне <strong>сообщение</strong> на <a>{{0}}</a> или воспользуйтесь формой',
    },
