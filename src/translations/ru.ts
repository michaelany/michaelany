...
const RU = {
  ...
  about: {
    text: 'Я инженер-программист, занимаюсь <0>фронтенд разработкой</0>. Создаю проекты любой сложности с нуля, воплощая в жизнь {{0}} идеи',
    feature: {
      projects: {
  ...
  experience: {
    ...
    stepper: {
      ...
      step15:
        'Работал <0>рководителем команды фронтенд разработки</0> в {{0}}. Продолжал сотрудничество по проектам с {{1}}',
      step16:
