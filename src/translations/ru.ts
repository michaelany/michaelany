  ...
  about: {
    ...
    feature: {
      ...
      travel: {
        ...
        text:
          'Посетил более {{0}} стран. В восторге от Японии и Новой Зеландии. Был в Хоббитоне, взобрался на вершину Фудзиямы и остался жив после встречи с уральским медведем на Перевале Дятлова {{1}}',
      },
      love: {
