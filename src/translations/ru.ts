...
const RU = {
  ...
  about: {
    text: `Я инженер-программист с 10-летним опытом во <0>фронтенд-разработке</0>. Создаю <1>проекты</1> разного масштаба и сложности, воплощая в жизнь <0>{{0}}</0>-идеи. Веду <2>${common.title.blog}</2> на <3>{{2}}</3>. Живу в Окленде, Новая Зеландия`,
    feature: {
      projects: {
