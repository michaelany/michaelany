...
const RU = {
  ...
  about: {
    text: 'Занимаюсь <0>фронтенд разработкой</0>. Создаю проекты любой сложности с нуля, воплощая в жизнь {{0}} идеи',
    feature: {
      projects: {
      ...
      growing: {
        ...
        text: 'Регулярно "затачиваю пилу", изучаю новые технологии, документации, статьи, курсы, книги и доклады. Ищу новые методы и инструменты повышения эффективности',
      },
      perfect: {
      ...
      sport: {
        ...
        text: 'Физические нагрузки особенно актуальны для разработчика и каждый день я занимаюсь спортом. Мне нравится калистеника, велосипед, бег и хайкинг. Этим летом открыл для себя сапсерфинг',
      },
      travel: {
        label: 'Путешественник',
        text: 'Побывал в {{0}} странах. В восторге от Японии и Новой Зеландии. Взобрался на вершину Фудзиямы, посетил Хоббитон и остался жив после встречи с уральским медведем на Перевале Дятлова {{1}}',
      },
      love: {
  ...
  skills: {
    ...
    feature: {
      ...
      test: {
        ...
        text: 'Проверяю работу проекта в различных браузерах и устройствах. Провожу рефакторинг кода. Замеряю и ускоряю загрузку ресурсов. Минифицирую и оптимизирую файлы, изображения',
      },
      tasks: {
  ...
  experience: {
    text: 'Профессионально занимаюсь фронтенд разработкой {{0}} лет. <0>Ведущий разработчик</0> и <0>тимлид</0>. Работаю удаленно',
    duties: 'Обязанности',
  ...
  portfolio: {
    limit: 'Коммерческие проекты, выпущенные в продакшн и разрешенные к показу',
