...
const RU = {
  ...
  about: {
    text: `Я инженер-программист, занимаюсь <0>фронтенд-разработкой</0>. Создаю <1>проекты</1> разной сложности и воплощаю в жизнь {{0}}-идеи. Веду <2>${common.title.blog}</2> на <3>{{2}}</3>. Живу в Окленде, Новая Зеландия`,
    feature: {
      projects: {
      ...
      experience: {
        label: '{{0}} лет коммерческого опыта',
      ...
      organizing: {
        ...
        text: 'Большинство проектов я вел самостоятельно. Мне нравится отвечать за всю клиентскую часть целиком: от обсуждения концепции до реализации, запуска и поддержки на продакшене',
      },
      programming: {
      ...
      blogger: {
        ...
        text: `Веду канал на {{0}}. Рассказываю о своем пути в программировании и жизни, делюсь опытом и знаниями. Подробнее в <0>Блоге</0> или на <1>{{0}}</1>`,
      },
      growing: {
        label: 'Постоянно учусь',
        text: 'Регулярно "затачиваю пилу": изучаю новые технологии, документацию, статьи, курсы, ролики, книги и доклады. Ищу методы и инструменты, которые помогают мне быть эффективнее',
      },
      perfect: {
        label: 'Склонный к перфекционизму',
        text: 'Качество - мой главный принцип. В каждый проект я вкладываюсь по максимуму, но опыт и дедлайны помогают держать баланс между скоростью и результатом',
      },
      education: {
      ...
      actor: {
        label: 'Бывший актер',
        text: 'Когда-то я снимался в кино, сериалах и рекламе, проводил мероприятия, подрабатывал аниматором и играл в учебном театре. Потом опомнился и ушел в разработку',
      },
      geek: {
        label: 'Техногик',
        text: 'Люблю технику, игры, аниме и {{0}}-культуру. Обожаю {{1}}, особенно серии {{2}} и {{3}}. В восторге от сериала «Аркейн». Интересуюсь гаджетами и железом. Собрал свой идеальный <0>сетап</0>',
      },
      resident: {
      ...
      sport: {
        ...
        text: 'Физическая нагрузка особенно важна для разработчика, поэтому каждый день я занимаюсь спортом. Люблю серфинг, калистенику, фитнес и хайкинг. Недавно открыл для себя скалолазание',
      },
      travel: {
