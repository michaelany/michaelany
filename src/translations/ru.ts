const RU = {
  ...
  about: {
    text:
      'Занимаюсь <strong>фронтенд разработкой</strong>. Создаю красивые и удобные проекты любой сложности, воплощая в жизнь {{value}} идеи',
    feature: {
      projects: {
      ...
      education: {
        ...
        text:
          'Окончил "Московский технологический университет" и "Всероссийский государственный институт кинематографии" 🙂. Учеба в последнем очень хорошо прокачала мои гибкие навыки',
      },
      sport: {
      ...
      love: {
        ...
        text:
          '<0>Она</0> - мой главный источник вдохновения и лучший друг. Мы вместе уже более {{textValue}} лет. Кстати, когда-то я разработал прогрессивное веб-приложение для предложения ей руки и сердца 🙂',
      },
      coffee: {
        label: 'Кофеман',
        text:
  ...
  skills: {
    ...
    feature: {
      ...
      markup: {
        label: 'Верстаю семантично, доступно, кроссбраузерно и {{textValue}}',
        text:
  ...
  experience: {
    ...
    job: {
      duty: {
        ...
        serviceDesk: 'Регистрация и обработка обращений в Service Desk',
        hardwareFix:
      ...
      achievement: {
        ...
        speed: 'Поставил личный рекорд скорости завершения проекта - 1 день',
