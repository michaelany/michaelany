  ...
  about: {
    ...
    feature: {
      ...
      perfect: {
        ...
        text: 'Качество - мой главный принцип. С вниманием отношусь к каждой детали проекта, при этом опыт и дедлайны помогают держать баланс между скоростью и результатом. Ценю консистентность, продуманную структуру и порядок во всем',
      },
      education: {
