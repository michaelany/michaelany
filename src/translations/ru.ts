const RU = {
  ...
  experience: {
    ...
    stepper: {
      ...
      step8:
        ' В результате успешного завершения проекта был приглашен в компанию "{{0}}" на должность р<strong>фронтенд-разработчика</strong>. Принял решение перейти из "{{1}}" в "{{2}}"',
      step9:
