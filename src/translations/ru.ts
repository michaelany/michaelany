...
const RU = {
  ...
  portfolio: {
    ...
    project: {
      vconline: {
        text: 'Корпоративное приложение финансовой компании',
      },
      vconlinel: {
  ...
  stopWar: {
    text: 'Я русский, но также и украинец, моя семья живет в России и на Украине. Родина напала на родину! Это безумие! <0>НЕТ ВОЙНЕ!</0>',
