  ...
  about: {
    ...
    feature: {
      ...
      position: {
        ...
        text: `Разрабатываю проекты с нуля, пишу бизнес-логику, верстаю, тестирую, оптимизирую и поддерживаю код. Планирую задачи, провожу код-ревью и обучаю. Подробнее в <0>${common.title.skills}</0>`,
      },
      experience: {
        label: '{{0}} лет опыта',
      ...
      organizing: {
        ...
        text: 'Большинство проектов я разработал самостоятельно. Мне нравится отвечать за всю клиентскую часть: от обсуждения концепции до реализации, запуска и поддержки на продакшене',
      },
      programming: {
        label: 'Люблю программировать',
        text: 'Фронтенд — мое основное хобби. Экспериментирую с {{0}}, {{1}} и нейросетями. Интересуюсь дизайном интерфейсов, языковыми моделями и кроссплатформенной разработкой',
      },
      blogger: {
      ...
      perfect: {
        ...
        text: 'Качество — мой главный принцип. С вниманием отношусь к каждой детали проекта, при этом опыт и дедлайны помогают держать баланс между скоростью и результатом. Ценю консистентность, системный подход, продуманную структуру и порядок во всем',
      },
      education: {
