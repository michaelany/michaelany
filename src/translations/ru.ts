...
const RU = {
  ...
  about: {
    text: 'Я инженер-программист, занимаюсь <0>фронтенд разработкой</0>. Создаю проекты любой сложности с нуля, воплощая в жизнь {{0}} идеи. Живу в Черногории',
    feature: {
      projects: {
  ...
  experience: {
    ...
    stepper: {
      ...
      step19:
        'Переехал в Черногорию. Занимался оформлением документов для получения рабочей визы в Новую Зеландию от компании {{0}} Получил рабочую визу. Готовлюсь к переезду в Новую Зеландию',
    },
  },
  portfolio: {
  ...
  stopWar: {
    text: 'Я русский, но также и украинец, моя семья живет в России и на Украине. Моя родина под руководством военных преступников напала на родину. Это безумие! <0>НЕТ ВОЙНЕ!</0>',
