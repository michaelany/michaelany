  ...
  about: {
    ...
    feature: {
      ...
      travel: {
        label: 'Traveler',
        text:
          'Visited over {{0}} countries. Love Japan and New Zealand. Visited Hobbiton, climbed the top of Fujiyama and survived after meeting with the Ural bear on the Dyatlov Pass {{1}}',
      },
      love: {
        label: 'Happy husband',
        text:
