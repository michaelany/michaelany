  ...
  experience: {
    ...
    job: {
      ...
      achievement: {
        ...
        cmsIntegration:
          'Integrated {{0}} {{1}} and configured the visual editor, enabling the marketing team to manage content independently',
        cmsArchitecture:
          'Designed a scalable architecture for blocks and components',
        externalBugFixes:
