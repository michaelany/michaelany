...
const extra = [
        ...
        {id: 3, text: 'Помимо всего прочего люблю путешествовать со своей девушкой (будущей женой) по миру. За последние два года успели побывать в Таиланде, Париже, Риге, на Крите, в Афинах, Барселоне, Кисловодске, а также совершили пеший поход на Перевал Дятлова.'}
];
