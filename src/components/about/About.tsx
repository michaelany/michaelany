...
const features: Feature[] = [
  ...
  },
  {
    ...
    Icon: CodeIcon,
    description: `Фронтенд - мое основное хобби. Мне нравится экспериментировать с ${TECHNOLOGY_TITLE.js} и ${TECHNOLOGY_TITLE.css}. Интересуюсь кроссплатформенной и бекенд-разработкой. Планирую запустить собственный блог по фронтенду.`,
  },
  {
