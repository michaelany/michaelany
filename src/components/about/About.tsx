...
const features: Feature[] = [
  ...
  },
  {
    ...
    Icon: CodeIcon,
    description: `Интересуюсь программированием, а фронтенд является моим основным хобби. В свободное нравится поэкспериментировать с ${TECHNOLOGY_TITLE.js} и ${TECHNOLOGY_TITLE.css}. Планирую запустить собственный блог по фронтенду.`,
  },
  {
