...
const jobs: IJob[] = [
  {
    ...
    duties: [
      ...
      'integration',
      'aiAgents',
      {tKey: 'performance', values: [FEATURE.seo]},
      'design',
      'graphics',
      'support',
      'tasks',
    ...
    achievements: [
      ...
      'cmsArchitecture',
      {tKey: 'seoRoadmap', values: [FEATURE.seo]},
      {
        tKey: 'convertExperiments',
        values: [TECHNOLOGY_TITLE.convert, FEATURE.ab],
      },
      {
        tKey: 'docs',
  ...
  },
  {
    ...
    achievements: [
      ...
      {tKey: 'foreignProjects', values: [SEVEN_GLYPHS_PROJECTS_COUNT]},
      'interfaces',
      'animations',
      'financeApp',
      'independent',
