...
const projects = [
    ...
    },
    {
        ...
        description: [
            ...
            {id: 3, text: 'Через какое-то время клиент запросил сделать редизайн и расширение функционала. Дизайнер выдал новый макет, я переверстал весь проект, после реализовал адаптивный интерфейс и начал подключать и связывать новый API. Работы и новшеств было много.'},
    ...
    },
    {
        ...
        description: [
            {id: 1, text: <span>Реализовал все view компоненты админки на шаблонизаторе Blade (Laravel). Работал в команде с разработчиком <Href href={LINKS.experience.sevenGlyphs}>"7 glyphs".</Href></span>},
    ...
    },
    {
        ...
        description: [
            {id: 1, text: <span>Проводил сопровождение и развитие view компонентов админки на шаблонизаторе Blade (Laravel). Работал в команде с разработчиком <Href href={LINKS.experience.sevenGlyphs}>"7 glyphs".</Href></span>},
            {id: 2, text: 'Проект уже был написан. Основными задачами были: реализация адаптивного интерфейса, расширение функционала и исправление ошибок. Шаблонизотр Blade, PHP, JavaScript / jQuery и Bootstrap вовсю мной использовались.'},
            {id: 3, text: 'В итоге сверстал адаптивный интерфейс, написал много скриптов, снова поработал с Blade и PHP.'}
        ],
        technologies: ['PHP', 'Laravel', 'ES5', 'jQuery', 'Bootstrap', 'Адаптивная верстка'],
        release: 'Июнь 2017',
        color: 'green',
    ...
    },
    {
        ...
        description: [
            {id: 1, text: <span>С нуля написанный мною проект. Реализовал всю клиентскую часть. Макета не было, был только примерный прототип с описанием функционала. Параллельно в команде <Href href={LINKS.experience.sevenGlyphs}>"7 glyphs"</Href> другие разработчики создавали API и iOS приложение.</span>},
            {id: 2, text: 'Так как дизайна не было, решил воспользоваться готовыми компонентами интерфейса. Всегда душа лежала к google material design. Начал верстку с использованием Material-UI компонентов. Когда был готов API, принялся проектировать и реализовывать бизнес-логику админки на Redux. Активно работал с датами, таблицами и пагинацией. Сейчас админка работает и я периодически вношу изменения по просьбе клиента.'},
            {id: 3, text: 'В итоге сверстал проект на Material-UI компонентах, спроектировал всю архитектуру и модель приложения, усвоил принципы работы с иммутабельными данными и мемоизацией.'},
        ],
    ...
    },
    {
        ...
        description: [
            {id: 1, text: <span>Суть проекта заключалась в создании целевых страниц для предостваления информации об услугах компании <Href href={LINKS.projects.sevenGlyphs}>"7 glyphs"</Href>. Реализовывал самостоятельно.</span>},
            {id: 2, text: 'Попросили сделать на React. Анимации, отложенная загрузка, адаптивные изображения и интерактивные элементы интерфейса - все это содержиться в проекте. Всего шесть страниц, струкрура практически одинаковая (различия в изображениях, текстах и некторох элементах). Создал одну основу для всех, различия поместил в data файл.'},
            {id: 3, text: 'В итоге сверстал адаптивный проект на React, познакомился с новыми подходами стилизации и работы с изображениями.'}
        ],
