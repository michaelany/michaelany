...
const abilities = [
    ...
    {id: 2, text: <span>Пользуюсь возможностями <strong>HTML5</strong></span>},
    {id: 3, text: <span>Пишу и встраиваю inline <strong>SVG</strong></span>},
    {id: 4, text: <span>Для простых страниц вместо React <strong>JSX</strong> предпочитаю шаблонизаторы:</span>,
        subItems: [
