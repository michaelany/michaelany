  ...
  const featuresRef = useRef<IFeature[]>([
    ...
    },
    {
      ...
      textValues: [
        ...
        TECHNOLOGY_TITLE.motion,
        TECHNOLOGY_TITLE.threejs,
      ],
    },
    {
      tKey: 'media',
    ...
    },
    {
      ...
      textValues: [
        ...
        TECHNOLOGY_TITLE.cloudflare,
        TECHNOLOGY_TITLE.azure,
        TECHNOLOGY_TITLE.vercel,
