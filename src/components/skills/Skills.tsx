  ...
  const features: Feature[] = useMemo(
    () => [
      ...
      },
      {
        ...
        Icon: ExtensionIcon,
        description:
          'Мемоизация, виртуализация, ленивая загрузка, деструктуризация, декоратор, каррирование, делегирование, рекурсия, модуль, фабрика, наблюдатель, прокси, примесь, наследование, async/await...',
      },
      {
      ...
      },
      {
        ...
        description:
          'Занимаюсь менторством, даю обратную связь по пулл-реквестам и делюсь опытом с коллегами. Разработал программу стажировки в компании. Есть опыт проведения собеседований.',
      },
    ],
    []
  )
