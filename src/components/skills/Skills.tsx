  ...
  const features: Feature[] = useMemo(
    () => [
      ...
      },
      {
        ...
        description: (
          <>
            ...
            использую большое количество вспомогательных библиотек и
            инструментов.
          </>
        ),
      },
      ...
      },
      {
        ...
        Icon: ListAltIcon,
        description: `Планирую бэклог, группирую, декомпозирую и оцениваю задачи. Применяю методологии Kanban / Scrum и GTD. Создал личную систему планирования. Использую таск-менеджеры. Пишу документацию.`,
      },
      {
    ...
    <Sections
      firstSection={
        <Info
          ...
          text={
            <>
              Разрабатываю приложения, лендинги, многостраничные сайты и
              админки. Основной стек - <strong>{TECHNOLOGY_TITLE.ts}</strong> +{' '}
              <strong>{TECHNOLOGY_TITLE.react}</strong> +{' '}
              <strong>{TECHNOLOGY_TITLE.redux}</strong>
            </>
          }
          features={features}
        />
